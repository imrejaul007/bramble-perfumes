...
<p class="mb-6">What my father left me is not a business. It is not a set of techniques or a customer list or a proprietary method for grading wood. What he left me is a way of being with agarwood. A way of being present with something rare and complex and alive. A way of understanding that knowledge is not a destination but a direction.</p>
<p class="mb-6">I have tried, in my own way, to honor this inheritance. NUHOUD is the result. It is my attempt to take everything I learned from my father — everything he learned from his father — and translate it into something new. Something that belongs to this moment. Something that can live in the world that my father and grandfather never knew.</p>
<p class="mb-6">They knew agarwood. I want to know it too. But I want to know it in a way that is mine.</p>`,
      isChapter: true
    },
    {
      id: 'ch4',
...
<p class="mb-6">I need to be honest about something. When I was young — really young, a teenager, the age when you start forming opinions about who you want to be — I didn't want anything to do with agarwood. Not because I didn't love it. Not because I didn't know it. But because I had watched my father, and I had seen what it had taken from him. The time. The energy. The way it consumed him.</p>
<p class="mb-6">I wanted to be something else. Someone else. I wanted a life that was not defined by resin and wood and the smell of something ancient. I wanted normalcy. I wanted a job where I could come home and leave it at the office. I wanted evenings and weekends that belonged to me, not to the thing I was trying to escape.</p>
<p class="mb-6">This lasted longer than I would like to admit. Through university. Through my early twenties. Through the years when I was supposed to be figuring out who I was and what I wanted to do with my life. I kept agarwood at a distance. I knew it — of course I knew it, I had been raised in it — but I held myself apart from it. I treated it like an obligation rather than an opportunity.</p>
<p class="mb-6">My father never pushed. That was his gift to me. He let me want something else. He let me struggle with it. He let me figure it out on my own time, in my own way, without pressure or guilt or manipulation. He understood something that many parents don't: you cannot give someone a relationship with a thing. You can only give them the conditions in which a relationship might grow.</p>

<p class="mb-6"><strong>The Piece From Lamding</strong></p>
<p class="mb-6">There was a piece. A specific piece of wood that changed everything for me. It came from Lamding — a place I had heard of but never visited. Lamding is known for producing some of the finest agarwood in the world. The trees there grow in conditions that are almost perfect for the formation of the resin that becomes agarwood. The wood from Lamding has a depth and complexity that is hard to find anywhere else.</p>
<p class="mb-6">The piece was not particularly large. Maybe the size of a fist. But when I held it in my hands, something happened. I don't know how to describe it except to say that I felt it. I felt the history of that piece. The years it had taken to form. The tree it had come from. The forest where that tree had grown. The hands that had found it and harvested it and brought it to market.</p>
<p class="mb-6">And I felt something else. Something I had not expected. I felt recognized. By the piece. By the wood itself. As if it had been waiting for someone to understand it, and I was that someone.</p>
<p class="mb-6">This is not a rational experience. I know that. I cannot prove what I felt. I cannot measure it or document it or explain it in terms that would satisfy a skeptic. But I felt it nonetheless. And it was the beginning of everything.</p>

<p class="mb-6"><strong>The Ride Home</strong></p>
<p class="mb-6">After I held that piece from Lamding, I drove home. It was late. The roads were quiet. And for the entire drive, I kept thinking about what had just happened. I kept returning to that moment in my father's warehouse when I held the piece and felt whatever it was that I felt.</p>
<p class="mb-6">I was forty minutes from home. Forty minutes of empty highway and streetlights and the quiet of the late evening. And in those forty minutes, something shifted. Not dramatically. Not all at once. But fundamentally. The thing I had been running from for most of my life — the thing I had kept at arm's length, the thing I had refused to embrace — I started to see it differently.</p>
<p class="mb-6">I started to see it as mine.</p>
<p class="mb-6">Not an obligation. Not a burden. Not my father's dream or my grandfather's legacy or the weight of family expectation. Mine. Something I could claim. Something I could build. Something I could make my own.</p>
<p class="mb-6">By the time I pulled into my driveway, I was different. I didn't know exactly what I was going to do. But I knew that I was done running.</p>

<p class="mb-6"><strong>When Smell Became Experience</strong></p>
<p class="mb-6">After that night, everything changed. I started paying attention in a way I never had before. The pieces of wood that I had walked past my whole life — the ones I had ignored or taken for granted — I started seeing them. Really seeing them. And when I got close enough to smell them, I started understanding them. Not intellectually. Not the way you understand a fact or a figure. The way you understand a piece of music or a work of art. With your whole self.</p>
<p class="mb-6">Smell is the most direct of the senses. It bypasses the thinking brain and goes straight to the emotional centers. When you smell something, you don't analyze it first — you feel it. And the feeling comes before the interpretation. You smell, you react, and only then do you try to understand what you've smelled and why it made you feel what you felt.</p>
<p class="mb-6">This is what I had been missing. This is what agarwood had been waiting to show me. Not the science of resin formation or the economics of the oud market or the history of the trade routes. The experience. The direct, unfiltered, emotional experience of encountering something extraordinary.</p>

<p class="mb-6"><strong>A Different Way of Smelling</strong></p>
<p class="mb-6">There is a way of smelling agarwood that most people never learn. You don't just put your nose to it and inhale. You hold it at a distance first. You let the scent reach you in layers. You give it time. You breathe in slowly, and then you breathe out slowly, and while you're breathing out, you breathe in again — a secondary inhalation that catches the deeper notes, the ones that don't reveal themselves immediately.</p>
...
<p class="mb-6">I practice this method now every time I encounter a new piece. It has become a ritual. A meditation. The world falls away, and there is only the wood and my breath and the slow revelation of everything the wood has to offer.</p>
<p class="mb-6">This is what NUHOUD is built on. This is the foundation. Not the business. Not the brand. The practice. The presence. The direct experience of something rare and beautiful and alive.</p>`,
      isChapter: true
    },
    {
      id: 'ch5',
...
<p class="mb-6">He had one of the finest noses in the business. Not an exaggeration — this was widely recognized. In the world of agarwood, where the ability to assess quality through smell is the most valuable skill a person can have, my friend was exceptional even among experts. People sought his opinion. They would bring him pieces and wait for his verdict. His word was trusted because his palate was true.</p>
<p class="mb-6">We had known each other for years. We had grown up in the same world, attended the same gatherings, argued about the same questions. But it was one evening — one specific conversation — that changed the way I thought about everything.</p>
<p class="mb-6">We were at an event. A gathering of people who cared about agarwood — collectors, traders, enthusiasts, a few craftsmen who had come to share and learn. The room was full of wood. Pieces of various origins, various grades, various qualities, spread out on tables for examination. I had been there for an hour, moving from piece to piece, doing what I always did: assessing, comparing, trying to understand.</p>
<p class="mb-6">My friend had been doing the same. But when we reconvened — when we found each other in a quiet corner of the room — his face was different. There was something there. A question. A puzzle. The look of a person who had encountered something they didn't expect.</p>

<p class="mb-6"><strong>This Is Sri Lankan</strong></p>
<p class="mb-6">"Come here," he said. "I want you to smell this."</p>
<p class="mb-6">He led me to a piece I had actually seen earlier. A piece I had passed over, honestly. It had looked ordinary. Not unremarkable, exactly, but not exceptional. The kind of piece that doesn't announce itself. The kind that requires attention to appreciate.</p>
...
<p class="mb-6">I looked at the piece again. I smelled it again. And this time, I tried to unlearn what I knew. I tried to set aside the categories, the assumptions, the mental frameworks I had built over decades of exposure to agarwood from specific, known, established sources.</p>
<p class="mb-6">What if it was Sri Lankan? What if the piece in front of me was not Vietnamese or Cambodian but Sri Lankan? What would that mean?</p>

<p class="mb-6"><strong>A Question That Refused to Leave</strong></p>
<p class="mb-6">The question lived with me for a long time. Longer than I expected. Longer than I wanted.</p>
<p class="mb-6">If Sri Lankan agarwood could smell like this — could be this complex, this deep, this extraordinary — then what did that mean? What did it mean about every assumption I had ever made about Sri Lankan agarwood? What did it mean about the other sources I had categorized as less important, less valuable, less worthy of attention?</p>
...
<p class="mb-6">NUHOUD was not supposed to happen this way. The plan — the one I had in my head for years, the one I used to justify my gradual approach to the family business — was to build something slow. Something careful. Something that would not require me to make decisions I wasn't ready to make.</p>
<p class="mb-6">I would work with my father. Learn from him. Eventually take over the family business. Maintain the existing relationships, the existing suppliers, the existing customers. Keep things going the way they had always been going. This was the plan. This was the safe path. This was the path that did not require me to believe in anything except continuity.</p>
<p class="mb-6">But then the question arrived. The Sri Lankan question. The one that refused to leave. And once a question like that takes hold, you cannot go back to the person you were before you asked it.</p>

<p class="mb-6"><strong>If We Were Going To Do It…</strong></p>
<p class="mb-6">My father and I had a conversation. I don't remember exactly where we were — a restaurant, probably, or his office. But I remember the feeling of the conversation. The weight of it. The sense that something was shifting.</p>
<p class="mb-6">"If we were going to do this," I said, "if we were going to actually pursue this — really search for the best, really try to find what we think is out there — then we need to commit. We can't do it halfway."</p>
<p class="mb-6">He looked at me. He had been waiting for this, I think. He had seen the question taking hold of me. He had watched me struggle with it. And now here I was, finally ready to say out loud what we both knew I was going to say eventually.</p>
<p class="mb-6">"What are you thinking?" he asked.</p>
<p class="mb-6">"I want to find the perfect oud oil. Not the most expensive. Not the most famous. The perfect one. The one that represents what this thing can be at its absolute best. And I want to build NUHOUD around that."</p>
<p class="mb-6">He was quiet for a long moment. And then he nodded.</p>
<p class="mb-6">"Okay," he said. "Let's do it."</p>

<p class="mb-6"><strong>Twenty Kilograms</strong></p>
<p class="mb-6">We started with twenty kilograms of Sri Lankan agarwood. Twenty kilograms of wood from a specific region, a specific type of tree, harvested at a specific time of year by people we trusted. Twenty kilograms of potential.</p>
<p class="mb-6">Twenty kilograms is not a lot, in the scheme of things. The agarwood market moves in much larger quantities. But we weren't thinking about quantity. We were thinking about quality. We were thinking about the piece from Lamding — the one that had changed everything for me. We were thinking about what might be possible if we were willing to search for it.</p>
...
<p class="mb-6">And we were not disappointed. The wood was extraordinary. Not all of it — you never get all extraordinary — but enough of it. Enough of it to know that we had found something. Something that deserved to be pursued.</p>

<p class="mb-6"><strong>I Wanted More</strong></p>
<p class="mb-6">Twenty kilograms was not enough. As soon as I smelled what those twenty kilograms could produce, I knew. I wanted more. I wanted to find every exceptional piece of Sri Lankan agarwood that we could access. I wanted to build a collection. A real collection — not a curated selection, not a greatest-hits of what the market already knew, but something deeper. Something more true.</p>
<p class="mb-6">My father understood. He had been waiting for this hunger in me. Not the hunger of a businessman seeking profit — though profit would come if the quality was real. The hunger of a person who has found something they believe in and cannot stop until they have found all of it.</p>
<p class="mb-6">We expanded the search. We reached out to contacts in Sri Lanka. We asked questions. We followed leads. We traveled when we could. We did not accept what the market offered us — we sought what we believed existed, and we refused to settle until we found it.</p>

<p class="mb-6"><strong>The Wood Has Its Own Composition</strong></p>
<p class="mb-6">Here is something that took me a long time to understand: the wood has its own composition. Not just the chemical composition — though that is part of it — but the composition of the thing itself. The tree. The forest. The climate. The specific combination of factors that produced this piece of agarwood at this moment in time.</p>
<p class="mb-6">Two pieces of agarwood from the same tree can be entirely different. The part of the tree, the age of the resin, the way it was harvested, the conditions under which it was stored — all of these factors change what the wood is. The wood is not a static object. It is a record of everything that has happened to it.</p>
<p class="mb-6">This is what we were searching for. Not just high-quality agarwood — that is available to anyone with enough money and connections. We were searching for the specific compositions. The specific records. The specific stories that wood can tell if you know how to listen.</p>

<p class="mb-6"><strong>The Search Had Began</strong></p>
<p class="mb-6">This is when it began. Not the business — the business came later, as a container for what we had found. But the search itself. The commitment to finding the exceptional. The willingness to look where no one else was looking, to ask questions that had no easy answers, to believe that there was more out there than what the market already knew.</p>
<p class="mb-6">NUHOUD exists because of this search. Everything we have done — every piece we have sourced, every oil we have released, every relationship we have built — has been an expression of this commitment. Not to the business of agarwood. To the thing itself. To the possibility that exceptional quality still exists, still can be found, still can be shared with people who are willing to seek it.</p>
<p class="mb-6">The search is not over. It will never be over. That is the point.</p>`,
      isChapter: true
    },
    {
      id: 'ch7',
...
<p class="mb-6">Sourcing exceptional agarwood is not like sourcing other luxury goods. There are no authorized dealers. No official certifications. No brand names that guarantee quality. You cannot go to a website and order the best agarwood in the world with next-day delivery. You have to find it. And finding it requires a different kind of hunt.</p>
<p class="mb-6">This hunt takes many forms. Sometimes it is a conversation — a casual mention by someone you trust, a reference to a person you have never heard of who lives in a place you have never visited. Sometimes it is a journey — an actual physical journey to a forest or a village or a warehouse where exceptional material might exist. Sometimes it is years of building relationships until someone, finally, shows you something they have been saving for the right person.</p>
<p class="mb-6">The hunt is not efficient. It is not scalable. It cannot be systematized or optimized. It requires presence. Patience. Trust. The willingness to show up, again and again, until the thing reveals itself.</p>

<p class="mb-6"><strong>The Philippines</strong></p>
<p class="mb-6">The Philippines surprised me. I had not expected much — agarwood from the Philippines was not on my radar, not in my mental model of where exceptional material came from. But my father had been there. He had been to the forests. He had seen what was growing there.</p>
<p class="mb-6">"Go," he said. "See for yourself."</p>
<p class="mb-6">I went. I spent time in the forests. I met the people who were working there — the harvesters, the local traders, the craftsmen who were processing the wood. I smelled what they had. I tasted it, the way you sometimes need to taste something to truly understand it.</p>
<p class="mb-6">What I found was unexpected. The Philippines had something. Not the same as Sri Lanka, not the same as Vietnam or Cambodia or Laos — but something. A character. A voice. Something that was distinctly Filipino in a way I had never encountered before.</p>
<p class="mb-6">We brought some back. We processed it. And it was good. Not the best we had found — but good. Interesting. Worth pursuing further. Worth understanding.</p>
<p class="mb-6">This is how it works. You go. You look. You smell. You listen. And sometimes, in places you did not expect, you find something worth hearing.</p>

<p class="mb-6"><strong>Six Kilograms</strong></p>
<p class="mb-6">There was a collector. A man who had spent decades building a private collection of exceptional agarwood from all over the world. He had pieces that I had never seen — not in my father's warehouse, not in the finest collections I had encountered. Rare material. Old material. Material that had been saved, carefully preserved, waiting for the right moment and the right person.</p>
<p class="mb-6">He agreed to meet with me. To show me what he had. I did not know what to expect.</p>
<p class="mb-6">He showed me six kilograms. Six kilograms of wood that stopped me in my tracks. The smell was... there are no words that do it justice. Complex. Deep. Ancient. Each piece had its own character, its own story, its own voice. But they were all speaking the same language — the language of exceptional quality, the language of something truly rare.</p>
<p class="mb-6">"This is what I have," he said. "This is everything I have been saving."</p>
<p class="mb-6">I did not haggle. I did not negotiate. I did not try to get a better price. I paid what he asked. Because some things are not about the price. Some things are about the moment. About recognizing when something is right in front of you and understanding that you may never see it again.</p>

<p class="mb-6"><strong>The Answer</strong></p>
<p class="mb-6">Six kilograms became part of the NUHOUD collection. Not all of it — some of it was not exceptional enough for what we were building. But enough of it. Enough to know that we were on the right path. Enough to validate the hunt.</p>
<p class="mb-6">And this is what I learned from that experience: the answer is always out there. It is not a question of whether exceptional agarwood exists — it does. It is not a question of whether it can be found — it can. The question is only whether you are willing to do what it takes to find it. Whether you are willing to travel. To wait. To build relationships. To show up again and again, even when you don't know if the search will pay off.</p>
<p class="mb-6">The answer is always out there. But it does not come to people who are looking for shortcuts.</p>

<p class="mb-6"><strong>The Wood Comes First</strong></p>
<p class="mb-6">Here is a principle that guides everything we do at NUHOUD: the wood comes first.</p>
<p class="mb-6">Not the brand. Not the packaging. Not the marketing story. Not the price point or the distribution strategy or the customer experience. The wood comes first. Everything else is secondary.</p>
<p class="mb-6">This seems obvious, but in practice it is revolutionary. Most of the agarwood business is built on other foundations — on relationships, on reputation, on the ability to move product. The quality of the wood is important, of course, but it is rarely the primary consideration. People buy from people they trust, from sources they know, in ways that are comfortable and familiar.</p>
...
<p class="mb-6">Malino is a region in Indonesia. It is known for many things — the coffee, the climate, the mountains. But it is not known for agarwood. At least, it was not known for agarwood. Not by anyone I had spoken to. Not in any of the literature I had read or the conversations I had had.</p>
<p class="mb-6">But my father had heard something. A rumor. A whisper. A suggestion that Malino might be producing something worth looking at. And so I went.</p>
<p class="mb-6">The journey was not easy. Malino is not a simple place to reach — it requires patience, flexibility, the willingness to go where the road takes you even when the road does not take you where you expected. I spent days there. I met people. I smelled wood. I tasted it, the way I had learned to do in the Philippines.</p>
<p class="mb-6">And I found something.</p>
<p class="mb-6">Not exceptional by the standards we had already established — but real. A voice that was distinctly Malino. A character that was its own. Something that had not been seen in the global agarwood market before. Something that belonged to a place that the world had not thought to look at.</p>
<p class="mb-6">We brought some back. We processed it. We released it as part of the NUHOUD collection. And it found its audience — people who recognized what it was, who understood that it was something new, something that had not existed in the market before.</p>

<p class="mb-6"><strong>What Others Might Call Leftovers</strong></p>
<p class="mb-6">In the agarwood business, there is a category of material that most people ignore. It is the material that is left over after the prime pieces have been selected. The smaller pieces. The less visually impressive pieces. The pieces that do not announce themselves. The material that most traders would call scraps.</p>
<p class="mb-6">We do not call them leftovers. We call them opportunity.</p>
<p class="mb-6">Here is what I have learned: the visual appearance of agarwood is a poor indicator of quality. The most valuable piece in a collection might be the smallest, the least dramatic, the piece that most people would walk past without stopping. And the piece that looks most impressive might produce oil that is merely ordinary.</p>
<p class="mb-6">We examine everything. We smell everything. We give every piece a chance to reveal itself. And sometimes — not often, but sometimes — the pieces that others ignored become the finest in our collection.</p>

<p class="mb-6"><strong>Another Forest Speaks</strong></p>
<p class="mb-6">The forests of Papua New Guinea are among the least explored in the world. Vast. Remote. Full of life that has not yet been documented by science. Full of agarwood that has not yet been assessed by the market.</p>
<p class="mb-6">We went there. Of course we went there. The question is not whether we should explore new forests — the question is always how and when. Papua New Guinea was next.</p>
<p class="mb-6">What we found was a voice. A distinct, unmistakable voice. Different from Sri Lanka. Different from the Philippines. Different from Malino. Different from anywhere we had looked before.</p>
<p class="mb-6">This is the pattern. This is what we have learned to expect. Every forest has a voice. Every place where agarwood grows has something to say. The challenge is not whether the voice exists — it always exists. The challenge is whether you are willing to listen.</p>

<p class="mb-6"><strong>Every Forest Has a Voice</strong></p>
<p class="mb-6">This is what NUHOUD is built on. Not a single source. Not a single origin. Not a single voice. Every forest has a voice. And our commitment — our real commitment, the one that goes beyond marketing and branding and all the surface-level things that businesses usually care about — is to listen.</p>
<p class="mb-6">We have found voices in Sri Lanka. In the Philippines. In Malino. In Papua New Guinea. In places we have not yet told you about. In forests we have not yet visited. In conversations we have not yet had.</p>
<p class="mb-6">The hunt continues. It will always continue. Because there is always another voice. There is always another forest. There is always more to discover, more to understand, more to share with people who are willing to listen.</p>

<p class="mb-6"><strong>Preservation</strong></p>
<p class="mb-6">I want to say something about preservation. About the responsibility that comes with exceptional resources.</p>
<p class="mb-6">Agarwood is not infinite. The trees that produce it are not abundant. The forests where it grows are under pressure. The knowledge of how to harvest it sustainably — knowledge that existed in traditional communities before industrialization and globalization disrupted everything — is being lost.</p>
<p class="mb-6">We are not naive about this. We understand that our business exists within a larger context — a context of ecological fragility, cultural complexity, ethical uncertainty. We make choices. We ask questions. We try to work with people who share our values, who understand that exceptional quality and sustainable practice are not in conflict.</p>
<p class="mb-6">This is not a perfect system. There is no perfect system. But we try. We try to be thoughtful. We try to be responsible. We try to remember that the wood we hold in our hands is not just a product — it is a gift. A gift from the forest. A gift from the tree. A gift from everyone who has touched it along the way.</p>
<p class="mb-6">We do not take that gift lightly.</p>
<p class="mb-6">And we will keep listening. To every forest. To every voice. For as long as there are forests to listen to. For as long as there are voices to hear.</p>
